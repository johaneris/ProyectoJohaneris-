...
//==========================================
bool isValidGender(const char* gender){
    return strcmp(gender, "masculino || Masculino") == 0 || strcmp(gender, "femenino || Femenino") == 0;
}
...
int getValidIDRegisternumber()
{
    ...
    {
        cout << "\033[1;36mIngrese el numero de su registro (solo numeros): \033[0m" ;
        cin >> id;
